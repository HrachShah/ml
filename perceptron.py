    ...
    def train(self, X, Y, alpha = 1.0, max_update = 1000, max_iter = 10000):
        ...
        for iter in range(max_iter):
            ...
            for i in I:
                ...
                err += 1
            print('Iter : %d\ttraining loss: %lf' % (iter, 1.0 * err / len(Y)), file=sys.stderr)
...
class Pocket(Perceptron):
    ...
    def train(self, X, Y, alpha = 1.0, max_update = 1000):
        ...
        while update <= max_update:
            ...
            if update % 100 == 0:
                print('Update : %d\ttraining loss: %lf' % (update, 1.0 * err / len(Y)), file=sys.stderr)
...
if __name__ == '__main__':
    ...
    print('Training accuracy for Perceptron : %lf%%' % (100 *  acc_train), file=sys.stderr)
    print('Test accuracy for Perceptron : %lf%%' % (100 *  acc_test), file=sys.stderr)
    ...
    print('Training accuracy for Pocket : %lf%%' % (100 *  acc_train), file=sys.stderr)
    print('Test accuracy for Pocket : %lf%%' % (100 *  acc_test), file=sys.stderr)
